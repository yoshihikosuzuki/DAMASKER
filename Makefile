...
ALL = datander TANmask REPmask HPC.TANmask HPC.REPmask LAshow4pathplot
...
LAshow4pathplot: LAshow.c align.c align.h DB.c DB.h QV.c QV.h
	gcc $(CFLAGS) -o LAshow4pathplot LAshow.c align.c DB.c QV.c -lm
